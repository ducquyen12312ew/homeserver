...
const char* action_str(Action a) {
    switch(a) {
        ...
        case ACT_SET_TIMER: return "set_timer";
        case ACT_LIST_TIMERS: return "list_timers";
        case ACT_DELETE_TIMER: return "delete_timer";
        case ACT_GET_LOGS: return "get_logs";
        default: return "unknown";
    }
}
...
static Action str_to_action(const char *s) {
    ...
    if (strcmp(s, "set_timer") == 0) return ACT_SET_TIMER;
    if (strcmp(s, "list_timers") == 0) return ACT_LIST_TIMERS;
    if (strcmp(s, "delete_timer") == 0) return ACT_DELETE_TIMER;
    if (strcmp(s, "get_logs") == 0) return ACT_GET_LOGS;
    return ACT_REGISTER;
}
